...
st.set_page_config(
    layout="wide",
    page_title="Planification dechargements",
    page_icon="🌐",
)
...
page = st.sidebar.selectbox(
    "Navigation",
    [ "Planification", "Stock","Navires en Rade"]
)
...
if page == "Planification":
    ...
    axe_usine_to_port = {
        ...
        "TB1": ["GH13"],
        "TB2": ["G1", "G2", "G3", "G4", "GH4", "GH3", "GH13"],
        "TB3": ["GH4"]
    }

    axe_Port_to_quai = {
    "G1": ["1S", "1N"], "G2": ["1S", "1N"], "G3": ["1BIS", "1TER"], "G4": ["1BIS", "1TER"], 
    "GH4": ["2S", "2N", "2BIS", "2TER"], "GH13": ["2BIS"],"GH3": ["2S", "2N", "2BIS", "2TER"],
    }
    ...
    def read_stock_from_excel(file, sheet_name):
        ...
        hangars = df.iloc[19:32, 1].dropna().tolist()
